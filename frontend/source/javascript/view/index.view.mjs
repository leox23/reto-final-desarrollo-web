...
export class IndexView {
  ...
  init(name) {
    ...
    this.#privateBody.innerHTML = paragraph;
    //this.#privateBody.append(paragraph);
    //this.#privateBody.innerHTML += `${this.#board.init()}`;
  }
...
<div class="container d-flex flex-row bd-highlight">
        <div id="container" class="boards-container">
    ...
    <button class="btn btn-ligth align-self-center" style="margin-left:20px; height: auto;" type="button">
